...
from iseeya.ai.gender import Gender
from iseeya.ai.expression import Expression
from iseeya.ai.multiple import Multiple
from iseeya.ai.face_detection import FaceDetection

from iseeya.ai.centroid_tracker import CentroidTracker
...
def load_models(path):
    ...
    return gender, expression, multiple, face_detection
